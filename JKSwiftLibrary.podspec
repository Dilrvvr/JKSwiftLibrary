...
#                       DESC
  ...
  s.homepage         = 'https://github.com/Dilrvvr/JKSwiftLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dilrvvr' => 'jkdev123cool@gmail.com' }
  s.source           = { :git => 'https://github.com/Dilrvvr/JKSwiftLibrary.git', :tag => s.version.to_s }
